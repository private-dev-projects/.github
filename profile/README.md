...
**AI & ML:** Stable Diffusion 2.1, LoRA Fine-Tuning, Modal (Serverless GPU), Claude API (Anthropic)  
...
**Published on iOS & Android · hand-coded** · [View on App Store](https://apps.apple.com/de/app/coloring-pictures/id6756795786)

A mobile app where users can choose from a collection of SVG images and color them digitally. Finished artwork can be saved and printed. The coloring pages are generated by a **custom AI pipeline** built on Stable Diffusion 2.1.

**Highlights:**
- Published on the **Apple App Store**
- Cross-platform with **React Native 0.81** and **Expo SDK 54**
- **AI-generated coloring pages** via a custom Stable Diffusion pipeline with category-specific LoRA weights
